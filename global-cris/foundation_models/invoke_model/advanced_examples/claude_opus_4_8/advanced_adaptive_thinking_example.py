#!/usr/bin/env python3
"""
Amazon Bedrock Global CRIS - Claude Opus 4.8 Adaptive Thinking + Effort (InvokeModel)

Demonstrates adaptive thinking combined with the effort parameter on Claude Opus 4.8:
- Adaptive thinking is the only supported thinking mode on Opus 4.8
...
Note: Claude Opus 4.8 does not support temperature, top_p, or top_k
...
# Global CRIS model ID for Claude Opus 4.8
MODEL_ID = "global.anthropic.claude-opus-4-8"


def invoke_with_adaptive_thinking(prompt: str, effort: str = "max", max_tokens: int = 16000):
    """
    Invoke Claude Opus 4.8 with adaptive thinking and effort control.

    Args:
        prompt: The user prompt.
        effort: Reasoning depth. Opus 4.8 supports:
                "low", "medium", "high", "xhigh", "max"
        max_tokens: Maximum output tokens.
    """
    # Note: temperature, top_p, top_k are NOT supported on Claude Opus 4.8
    request_body = {
        ...
        # Adaptive thinking: only supported thinking mode on Opus 4.8
...
print("🌍 Amazon Bedrock Global CRIS - Claude Opus 4.8 Adaptive Thinking + Effort")
print("🚀 Model: Claude Opus 4.8 (Global CRIS)")
...
try:
    ...
    print("💡 Opus 4.8 effort levels: low, medium, high, xhigh, max")
