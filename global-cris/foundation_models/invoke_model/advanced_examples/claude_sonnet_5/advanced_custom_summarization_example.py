#!/usr/bin/env python3
"""
Amazon Bedrock Global CRIS - Claude Sonnet 5 Custom Summarization (InvokeModel)
...
- Blog: https://aws.amazon.com/blogs/machine-learning/introducing-claude-sonnet-5-on-aws-anthropics-most-capable-sonnet-model/
...
print("🌍 Amazon Bedrock Global CRIS - Claude Sonnet 5 Custom Summarization")
...
print("💡 Adaptive thinking is ALWAYS ON in Sonnet 5")
