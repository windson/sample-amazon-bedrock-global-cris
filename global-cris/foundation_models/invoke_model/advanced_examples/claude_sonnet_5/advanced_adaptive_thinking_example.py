#!/usr/bin/env python3
"""
Amazon Bedrock Global CRIS - Claude Sonnet 5 Adaptive Thinking + Effort (InvokeModel)

Demonstrates adaptive thinking combined with the effort parameter on Claude Sonnet 5:
- Adaptive thinking is ALWAYS ON in Sonnet 5 — it cannot be disabled
...
def invoke_with_adaptive_thinking(prompt: str, effort: str = "max", max_tokens: int = 16000):
    """
    Invoke Claude Sonnet 5 with adaptive thinking and effort control.

    Note: Adaptive thinking is ALWAYS ON in Sonnet 5 — it cannot be disabled.
    The effort parameter controls reasoning depth.

    Args:
        prompt: The user prompt.
        effort: Reasoning depth. Sonnet 5 supports:
                "low", "medium", "high", "xhigh", "max"
        max_tokens: Maximum output tokens.
    """
    # Note: temperature, top_p, top_k are NOT supported on Claude Sonnet 5
    request_body = {
        "anthropic_version": "bedrock-2023-05-31",
        # Effort beta header — required to use output_config.effort
        "anthropic_beta": ["effort-2025-11-24"],
        "max_tokens": max_tokens,
        # Adaptive thinking: ALWAYS ON in Sonnet 5 (cannot be disabled)
        "thinking": {
            "type": "adaptive"
        },
...
print("🌍 Amazon Bedrock Global CRIS - Claude Sonnet 5 Adaptive Thinking + Effort")
...
print("💡 Adaptive thinking is ALWAYS ON in Sonnet 5 — effort controls depth")
...
try:
    ...
    print("💡 Sonnet 5 effort levels: low, medium, high, xhigh, max")
