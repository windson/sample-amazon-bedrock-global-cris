#!/usr/bin/env python3
"""
Amazon Bedrock Global CRIS - Claude Opus 5 Prompt Caching (InvokeModel)

Demonstrates prompt caching for reduced latency and cost:
...
def invoke_with_prompt_caching(user_message: str):
    """
    Invoke Claude Opus 5 with prompt caching enabled.
    ...
    request_body = {
        ...
        # cache_control type "ephemeral" triggers caching at this checkpoint
        "system": [
            {
                "type": "text",
    ...
    return text_response, model_response.get("usage", {})


print("🌍 Amazon Bedrock Global CRIS - Claude Opus 5 Prompt Caching")
...
try:
    ...
    response_text, usage = invoke_with_prompt_caching(question_1)
    ...
    start_time = time.time()
    response_text, usage = invoke_with_prompt_caching(question_2)
