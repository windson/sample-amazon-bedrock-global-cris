...
Demonstrates basic Claude Opus 4.8 streaming with Global CRIS
...
see advanced_examples/claude_opus_4_8/
...
try:
    ...
    # Note: temperature, top_p, and top_k are not supported in Opus 4.8
    native_request = {
