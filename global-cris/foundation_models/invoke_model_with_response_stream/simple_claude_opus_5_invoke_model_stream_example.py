...
Demonstrates basic Claude Opus 5 streaming with Global CRIS
...
For advanced features like adaptive thinking, prompt caching, computer use,
and compaction, see advanced_examples/claude_opus_5/
...
try:
    ...
    # Note: temperature, top_p, and top_k are not supported in Opus 5
    native_request = {
