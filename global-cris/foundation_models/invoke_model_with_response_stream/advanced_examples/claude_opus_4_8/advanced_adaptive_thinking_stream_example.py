#!/usr/bin/env python3
"""
Amazon Bedrock Global CRIS - Claude Opus 4.8 Adaptive Thinking + Effort
...
print("🌍 Amazon Bedrock Global CRIS - Claude Opus 4.8 Adaptive Thinking + Effort (Streaming)")
