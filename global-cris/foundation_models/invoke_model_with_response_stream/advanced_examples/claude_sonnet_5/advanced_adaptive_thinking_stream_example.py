#!/usr/bin/env python3
"""
Amazon Bedrock Global CRIS - Claude Sonnet 5 Adaptive Thinking + Effort
...
print("🌍 Amazon Bedrock Global CRIS - Claude Sonnet 5 Adaptive Thinking + Effort (Streaming)")
