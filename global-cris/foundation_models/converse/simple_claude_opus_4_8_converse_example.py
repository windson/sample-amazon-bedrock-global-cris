...
Demonstrates basic usage of Claude Opus 4.8 with Global CRIS
...
try:
    print("🚀 Invoking Claude Opus 4.8 via Global CRIS...")
    ...
    print("💡 Claude Opus 4.8 is Anthropic's most capable GA model with 1M context window")
