...
| Claude Opus 5 | `global.anthropic.claude-opus-5` | [converse](global-cris/foundation_models/converse/simple_claude_opus_5_converse_example.py) | [stream](global-cris/foundation_models/converse_stream/simple_claude_opus_5_converse_stream_example.py) | [invoke](global-cris/foundation_models/invoke_model/simple_claude_opus_5_invoke_model_example.py) | [stream](global-cris/foundation_models/invoke_model_with_response_stream/simple_claude_opus_5_invoke_model_stream_example.py) |
...
| Claude Opus 5 | Adaptive Thinking + Disable | [invoke](global-cris/foundation_models/invoke_model/advanced_examples/claude_opus_5/advanced_adaptive_thinking_example.py) | [stream](global-cris/foundation_models/invoke_model_with_response_stream/advanced_examples/claude_opus_5/advanced_adaptive_thinking_stream_example.py) |
| Claude Opus 5 | Prompt Caching | [invoke](global-cris/foundation_models/invoke_model/advanced_examples/claude_opus_5/advanced_prompt_caching_example.py) | [stream](global-cris/foundation_models/invoke_model_with_response_stream/advanced_examples/claude_opus_5/advanced_prompt_caching_stream_example.py) |
| Claude Opus 5 | Computer Use | [invoke](global-cris/foundation_models/invoke_model/advanced_examples/claude_opus_5/advanced_computer_use_example.py) | [stream](global-cris/foundation_models/invoke_model_with_response_stream/advanced_examples/claude_opus_5/advanced_computer_use_stream_example.py) |
| Claude Opus 5 | Compaction | [invoke](global-cris/foundation_models/invoke_model/advanced_examples/claude_opus_5/advanced_compaction_example.py) | [stream](global-cris/foundation_models/invoke_model_with_response_stream/advanced_examples/claude_opus_5/advanced_compaction_stream_example.py) |
...
| Claude Opus 5 | 1M | 128K | Adaptive thinking (ON by default, CAN be disabled) | **Not supported** | Most capable Opus, prompt caching, computer use |
...
- [Claude Opus 5 on AWS (Blog)](https://aws.amazon.com/blogs/machine-learning/introducing-claude-opus-5-on-aws-anthropics-most-capable-opus-model/)
